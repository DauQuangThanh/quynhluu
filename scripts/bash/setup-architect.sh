...
# setup-architect.sh - Setup script for /quynhluu.architect command
...
ARCH_TEMPLATE=".quynhluu/templates/templates-for-commands/arch-template.md"
...
if [ ! -f "docs/ground-rules.md" ]; then
    echo "ERROR: Ground rules file not found: docs/ground-rules.md. Run /quynhluu.set-ground-rules first." >&2
    exit 1
fi
...
if [ "$JSON_OUTPUT" = true ]; then
    ...
    echo "   4. Run feature implementation plans with /quynhluu.design"
    echo ""
fi
