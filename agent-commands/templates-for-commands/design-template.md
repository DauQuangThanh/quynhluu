...
**Note**: This template is filled in by the `/quynhluu.design` command.
...
```text
specs/[###-feature]/
├── design.md            # This file (/quynhluu.design command output)
├── research.md          # Phase 0 output (/quynhluu.design command)
├── data-model.md        # Phase 1 output (/quynhluu.design command)
├── quickstart.md        # Phase 1 output (/quynhluu.design command)
├── contracts/           # Phase 1 output (/quynhluu.design command)
└── tasks.md             # Phase 2 output (/quynhluu.taskify command - NOT created by /quynhluu.design)
```
