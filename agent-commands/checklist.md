...
5. **Generate checklist** - Create "Unit Tests for Requirements":
   ...
   - Each `/quynhluu.checklist` run creates a NEW file (never overwrites existing checklists)
...
**Important**: Each `/quynhluu.checklist` command invocation creates a checklist file using short, descriptive names unless file already exists. This allows:
