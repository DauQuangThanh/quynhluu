...
CURSOR_FILE="$REPO_ROOT/.cursor/rules/quynhluu-rules.mdc"
QWEN_FILE="$REPO_ROOT/QWEN.md"
AGENTS_FILE="$REPO_ROOT/AGENTS.md"
WINDSURF_FILE="$REPO_ROOT/.windsurf/rules/quynhluu-rules.md"
KILOCODE_FILE="$REPO_ROOT/.kilocode/rules/quynhluu-rules.md"
AUGGIE_FILE="$REPO_ROOT/.augment/rules/quynhluu-rules.md"
ROO_FILE="$REPO_ROOT/.roo/rules/quynhluu-rules.md"
...
# Template file
TEMPLATE_FILE="$REPO_ROOT/.quynhluu/templates/templates-for-commands/agent-file-template.md"
