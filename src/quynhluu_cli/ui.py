"""UI components and interactive elements for Quynhluu CLI."""
...
app = typer.Typer(
    name="quynhluu",
    help="Setup tool for Quynhluu spec-driven development projects",
...
def callback(ctx: typer.Context):
    ...
    if ctx.invoked_subcommand is None and "--help" not in sys.argv and "-h" not in sys.argv:
        show_banner()
        console.print(Align.center("[dim]Run 'quynhluu --help' for usage information[/dim]"))
        console.print()
