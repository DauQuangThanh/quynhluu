"""Configuration constants and agent definitions for Quynhluu CLI."""
...
TAGLINE = "Hanoi Quynhluu - Drive Quality Together with Agentic AI"

# GitHub repository information
GITHUB_REPO_OWNER = "dauquangthanh"
GITHUB_REPO_NAME = "hanoi-quynhluu"
