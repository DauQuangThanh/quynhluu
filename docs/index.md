...
**New to Quynhluu?** Follow these guides:

| Guide | Description |
| ------- | ------------- |
| 📦 [Installation Guide](installation.md) | Set up Quynhluu CLI and prerequisites |
...
| Command | Purpose |
| --------- | ---------- |
| `/quynhluu.set-ground-rules` | Set project principles and ground rules (Greenfield) |
| `/quynhluu.assess-context` | Analyze existing codebase (Brownfield alternative to set-ground-rules) |
| `/quynhluu.specify` | Define requirements and user stories |
| `/quynhluu.clarify` | Clarify underspecified areas through structured questioning |
| `/quynhluu.architect` | Design system architecture with C4 diagrams |
| `/quynhluu.standardize` | Create coding standards and conventions |
| `/quynhluu.design` | Create technical implementation plans |
| `/quynhluu.taskify` | Break down into actionable tasks |
| `/quynhluu.analyze` | Check consistency across specifications |
| `/quynhluu.implement` | Execute all tasks and build the feature |
| `/quynhluu.design-e2e-test` | Design end-to-end test specifications |
| `/quynhluu.perform-e2e-test` | Execute end-to-end tests |
| `/quynhluu.checklist` | Generate quality validation checklists |
| `/quynhluu.tasks-to-issues` | Convert tasks to GitHub issues |
| `/quynhluu.tasks-to-ado` | Convert tasks to Azure DevOps work items |
...
- 📖 [Support Guide](https://github.com/dauquangthanh/hanoi-quynhluu/blob/main/SUPPORT.md) - Common questions and solutions
- 🐛 [Open an Issue](https://github.com/dauquangthanh/hanoi-quynhluu/issues/new) - Report bugs or request features
- 💭 [Discussions](https://github.com/dauquangthanh/hanoi-quynhluu/discussions) - Ask questions and share ideas
